...
parser.add_argument('--outf', default='./log/Horse/exp2', help='folder to output images and model checkpoints')
parser.add_argument('--dataroot', default='./Horse_SData', help='path to dataset root dir')
...
parser.add_argument('--cuda', default=0, type=int, help='enables cuda')
